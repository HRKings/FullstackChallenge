...
namespace Challenge.EF.Controllers
{
	...
	public class AssociationController : ControllerBase
	{
		...
		public async Task<IActionResult> GetTeachers([FromServices] ChallengeDbContext dbContext,
		...
		[ProducesResponseType(StatusCodes.Status404NotFound)]
		public async Task<IActionResult> GetStudents([FromServices] ChallengeDbContext dbContext,
			[FromQuery] int page = 0, [FromQuery] int pageSize = 10)
		{
			List<Attend> result;
			if (page == 0)
